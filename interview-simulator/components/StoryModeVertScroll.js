...
export default function StoryModeVertScroll({
  navigation,
  onReplaceSkinClick,
}) {
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <StoryLevel
          ...
          skin={bbbTheme.sinior}
          avatars={bbbTheme.avatars}
        />
        <StoryLevel
          level={5}
          navigation={navigation}
          skin={ftwTheme.about}
          avatars={bbbTheme.middle}
        />
        <StoryLevel
          level={4}
          navigation={navigation}
          skin={ftwTheme.quiz}
          avatars={soberTheme.bosses}
        />
        <StoryLevel
          level={3}
          navigation={navigation}
          skin={soberTheme.welcomeBgs}
          avatars={defaultBosses.middle}
        />
        <StoryLevel
          level={2}
          navigation={navigation}
        ...
        <StoryLevel
          level={1}
          navigation={navigation}
          skin={ftwTheme.pyramid}
          avatars={ftwTheme.avatarsFunny}
        />
      </ScrollView>
    </View>
  );
